...
public class DBGifReader4 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String exper_no = req.getParameter("exper_no").trim();
			ResultSet rs = stmt.executeQuery(
				"SELECT exper_picture FROM experience  WHERE exper_no ='"+exper_no+"'" );
//+ req.getParameter("PID")
			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("exper_picture"));
