...
<%
	TransactionsVO transactionsVO = (TransactionsVO) request.getAttribute("transactionsVO");
...
<title>會員資料新增 - addTransactions.jsp</title>

<link rel="icon" href="<%=request.getContextPath()%>/picture/logo.png">
<script src="<%=request.getContextPath()%>/js/vendors/jquery/jquery.min.js"></script>
...
<div class="checkout">
  ...
  <form class="form" autocomplete="off" novalidate  METHOD="post" ACTION="<%=request.getContextPath() %>/transactions/transactions.do" >
    <fieldset>
    ...
    <fieldset>
      <label for="card-holder">Deposit</label>
      <input type="TEXT" name="deposit" size="45" value="${transactionsVO.deposit}" />
    </fieldset>
    ...
    <input type="submit" value="submit" class="btn1"><i class="fa fa-lock"></i>
...
$('#magic').click(function(){
	$('#card-number').val("9514");
	$('#card-number-1').val("4853");
	$('#card-number-2').val("7169");
	$('#card-number-3').val("4116");
	$('#card-holder').val("小智");
	$('#deposit').val("5000");
	$('#card-expiration-month').val("09");
